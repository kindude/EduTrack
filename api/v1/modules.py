...
async def get_modules(module_service: Annotated[ModulesService, Depends(get_modules_service)]) -> List[ModuleUsers]:
...
async def add_module(module_add: ModuleAddRequest, module_service: Annotated[ModulesService, Depends(get_modules_service)],
